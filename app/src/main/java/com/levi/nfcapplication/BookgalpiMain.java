...
public class BookgalpiMain extends AppCompatActivity {
                            ...
                            public void onReaderDetection(BluetoothReader reader) {
                                ...
                                if (reader instanceof Acr3901us1Reader) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
                                            Toast.makeText(BookgalpiMain.this,
                                ...
                                if (sta == BluetoothReader.CARD_STATUS_PRESENT  ){
                                    ...
                                    if (apduCommand != null && apduCommand.length > 0) {
                                        ...
                                        if (!reader.transmitApdu(apduCommand)) {
                                            Toast.makeText(BookgalpiMain.this,R.string.card_reader_not_ready, Toast.LENGTH_LONG).show();
                                        }else{
                                        }
                                    } else {
                                        Toast.makeText(BookgalpiMain.this,"Character format error!", Toast.LENGTH_LONG).show();
                                    }
                                }
                            }
                        });
                            ...
                            public void run() {
                                if (errorCode == BluetoothReader.ERROR_SUCCESS) {
                                    ...
                                    if (!reader.transmitEscapeCommand(mBluetoothAPI.AUTO_POLLING_START)) {
                                        ...
                                        //Constants.isScanning = false;
                                        Toast.makeText(BookgalpiMain.this,"NFC (Bluetooth) Connected",Toast.LENGTH_LONG).show();
                                    }
